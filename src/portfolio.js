 // src/portfolio.js
  ...
  export async function addPortfolioItem(redis, userId, item) {                                                                                                                                         
    ...
    pipeline.hset(PORT_ITEM_KEY(userId, itemId),
      Object.fromEntries(
        Object.entries(record).map(([k, v]) => [k, v === null || v === undefined ? "" : typeof v === "object" ? JSON.stringify(v) : String(v)])                                                         
      )                                                                                                                                                                                                 
    );                                                                                                                                                                                                  
  ...
  export async function markPortfolioItemSold(redis, userId, itemId, { soldPrice, platform = null } = {}) {                                                                                             
    if (!redis || !userId || !itemId) return null;
    ...
    const updated = {                                                                                                                                                                                 
      ...existing,
      soldAt:       now,
      soldPrice:    Number.isFinite(sp) ? sp : null,
    ...
    pipeline.hset(PORT_ITEM_KEY(userId, itemId),                                                                                                                                                        
      Object.fromEntries(                                                                                                                                                                             
        Object.entries(updated).map(([k, v]) => [k, v === null || v === undefined ? "" : typeof v === "object" ? JSON.stringify(v) : String(v)])                                                        
      )                                                                                                                                                                                                 
    );                                                                                                                                                                                                  
    ...
    const avgHoldDays      = soldItems.length
      ? Math.round(                                                                                                                                                                                     
          soldItems.reduce((sum, i) => {                                                                                                                                                              
            const held = (i.soldAt - i.addedAt) / (1000 * 86400);                                                                                                                                       
            return sum + held;                                                                                                                                                                          
          }, 0) / soldItems.length
        )                                                                                                                                                                                               
      : null;                                                                                                                                                                                         
